using PIService as service from '../../srv/coupa-service';
...
annotate service.PIRequests with @(
    ...
    UI.Identification: [
        { $Type: 'UI.DataFieldForAction', Action: 'PIService.submit', Label: 'Submit' },
...
annotate service.PIRequests actions {
    submit @(
        Common.SideEffects : {
    ...
    identificationType_code @(
        ...
        Common.ValueList: {
            ...
            Parameters: [
                ...
                { $Type: 'Common.ValueListParameterDisplayOnly', ValueListProperty: 'name' },
                { $Type: 'Common.ValueListParameterDisplayOnly', ValueListProperty: 'descr' },
                { $Type: 'Common.ValueListParameterConstant', Constant: 'PI', ValueListProperty: 'code' }
            ]
        }
    );
