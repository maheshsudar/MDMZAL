sap.ui.define([
    ...
    return ControllerExtension.extend("com.company.salesforcerequests.ext.controller.ListReportExt", {
        override: {
            onInit: function () {
        ...
        _addCustomButtons: function () {
            ...
            var oTable = oView.byId("fe::table::SalesforceRequests::LineItem");
            if (!oTable) {
        ...
        _showSearchDialog: function (sMode) {
            ...
            if (!this._pDialog) {
                this._pDialog = Fragment.load({
                    id: oView.getId(),
                    name: "com.company.salesforcerequests.ext.fragment.SearchPartnerDialog",
                    controller: this
                        ...
                        "Change request " + oResult.requestNumber + " has been created successfully for SAP Business Partner " + sSapBpNumber + ".\n\nWould you like to open the request now?",
                        {
                            ...
                            onClose: function (sAction) {
                                if (sAction === MessageBox.Action.YES) {
                                    ...
                                    var sHash = "#/SalesforceRequests(ID=" + oResult.requestId + ",IsActiveEntity=true)";
