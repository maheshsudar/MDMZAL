...
service CoupaService @(path:'/coupa') {
  ...
  entity PartnerAddresses as projection on db.PartnerAddresses {
    *,
    request : redirected to CoupaRequests,
    virtual null as fieldControl : UInt8
  };
...
annotate CoupaService.CoupaRequests with actions { submit @Core.OperationAvailable: isSubmittable };
